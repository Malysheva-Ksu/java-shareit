...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, String>> handleMissingParams(final MissingServletRequestParameterException e) {
        String message = String.format("Required ru.practicum.request parameter '%s' for method parameter type %s is not present",
    ...
    public ResponseEntity<Map<String, String>> handleMissingHeader(final MissingRequestHeaderException e) {
        String message = String.format("Required ru.practicum.request header '%s' for method parameter type %s is not present",
