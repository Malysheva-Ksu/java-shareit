...
public class ItemClient extends BaseClient {
    ...
    @Autowired
    public ItemClient(@Value("${shareit-server.url}") String serverUrl, RestTemplateBuilder builder, Class<? extends ClientHttpRequestFactory> httpComponentsClientHttpRequestFactory) {
        super(
                builder
